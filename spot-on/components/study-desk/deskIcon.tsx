...
function CircularDesk1Seat({ c, size }: { c: typeof COLORS.available; size: number }): JSX.Element {
  return (
...
function CircularDesk4Seats({ c, size }: { c: typeof COLORS.available; size: number }): JSX.Element {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
      {/* Desk */}
      <circle cx="50" cy="50" r="22" fill={c.desk} stroke={c.stroke} strokeWidth="2" />
...
function RectangularDesk1Seat({ c, size }: { c: typeof COLORS.available; size: number }): JSX.Element {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
      {/* Desk */}
...
function RectangularDesk4Seats({ c, size }: { c: typeof COLORS.available; size: number }): JSX.Element {
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
      {/* Desk */}
...
function DeskIcon({ shape, seats, status, size = 100 }: DeskIconProps): JSX.Element {
