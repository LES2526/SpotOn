...
const piso1SpacesData = [
    { name: 'Mesa P1-01', points: '595,122 664,122 664,191 595,191', capacity: 1, qr: 'qr-mesa-p1-01', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    ...
    { name: 'Mesa P1-10', points: '2015,151 2187,151 2187,326 2015,326', capacity: 1, qr: 'qr-mesa-p1-10', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-11', points: '517,210 624,210 624,312 517,312', capacity: 1, qr: 'qr-mesa-p1-11', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    ...
    { name: 'Mesa P1-16', points: '2150,307 2312,307 2312,471 2150,471', capacity: 1, qr: 'qr-mesa-p1-16', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-17', points: '1987,482 2094,482 2094,584 1987,584', capacity: 1, qr: 'qr-mesa-p1-17', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-18', points: '2378,572 2673,572 2673,890 2378,890', capacity: 1, qr: 'qr-mesa-p1-18', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    ...
    { name: 'Mesa P1-20', points: '2075,581 2182,581 2182,683 2075,683', capacity: 1, qr: 'qr-mesa-p1-20', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    ...
    { name: 'Mesa P1-22', points: '2051,946 2207,946 2207,1069 2051,1069', capacity: 1, qr: 'qr-mesa-p1-22', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-23', points: '2567,948 2673,948 2673,1051 2567,1051', capacity: 1, qr: 'qr-mesa-p1-23', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-24', points: '2453,1082 2559,1082 2559,1185 2453,1185', capacity: 1, qr: 'qr-mesa-p1-24', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    ...
    { name: 'Mesa P1-26', points: '655,1158 811,1158 811,1272 655,1272', capacity: 1, qr: 'qr-mesa-p1-26', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-27', points: '2109,1134 2215,1134 2215,1237 2109,1237', capacity: 1, qr: 'qr-mesa-p1-27', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-28', points: '2406,1213 2475,1213 2475,1282 2406,1282', capacity: 1, qr: 'qr-mesa-p1-28', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-29', points: '2000,1246 2106,1246 2106,1349 2000,1349', capacity: 1, qr: 'qr-mesa-p1-29', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-30', points: '616,1332 760,1332 760,1467 616,1467', capacity: 1, qr: 'qr-mesa-p1-30', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-31', points: '2214,1357 2320,1357 2320,1460 2214,1460', capacity: 1, qr: 'qr-mesa-p1-31', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-32', points: '2082,1416 2241,1416 2241,1617 2082,1617', capacity: 1, qr: 'qr-mesa-p1-32', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    { name: 'Mesa P1-33', points: '702,1447 809,1447 809,1550 702,1550', capacity: 1, qr: 'qr-mesa-p1-33', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
    ...
    { name: 'Mesa P1-39', points: '2009,1594 2115,1594 2115,1697 2009,1697', capacity: 1, qr: 'qr-mesa-p1-39', type: SpaceType.INDIVIDUAL_DESK, hasPowerOutlet: false, description: 'Mesa piso 1' },
