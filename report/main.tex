...
alto nível, as camadas lógicas, e as principais decisões técnicas com as
...
O diagrama de componentes detalhado da arquitetura está disponível no
repositório em \texttt{diagrams/component/backend\_arquitecture.drawio}.
...
O diagrama UML de classes do domínio está disponível em
\texttt{diagrams/class/domain\_class\_diagram.drawio}, mantido em formato
\emph{drawio} para facilitar a sua edição em conjunto com a evolução do
\emph{schema}.
...
organizados por recurso. Os grupos atualmente disponíveis são:
